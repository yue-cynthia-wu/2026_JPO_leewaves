...
!          do j=1,NJ-1
!             k=0
! !            Jz(j,k)= rho(i,j+1,k+1) - rho(i,j,k+1)
! !            dzeta(j,k)= (zc(i,j+1,k+1) -zc(i,j,k+1) )*DL
!             Jy(j,k)= 0.5*(rho(i,j+1,k+1)+rho(i,j+1,k+2) - (rho(i,j,k+1) +rho(i,j,k+2)) )
!             dzeta(j,k)= 0.5*(zc(i,j+1,k+1) +zc(i,j+1,k+2) - (zc(i,j,k+1) + zc(i,j,k+2)) )*DL
!             do k=1,NK-1
...
! c     periodic boundaries
      ...
      do j=1,NJ
         ...
         do i=1,NI-1
            k=0
            Jx2(i,0)= 0.5*(rho(i,j,k+2) +rho(i+1,j,k+2) - (rho(i,j,k+1) + rho(i+1,j,k+1)) )
         ...
         i=NI
         k=0
         Jx2(i,0)= 0.5*(rho(i,j,k+2) +rho(1,j,k+2) - (rho(i,j,k+1) + rho(1,j,k+1)) )
